...
if (isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        // Mailtrap SwiftMailer configuration
        $transport = (new Swift_SmtpTransport('live.smtp.mailtrap.io', 587, 'tls'))
            ->setUsername('api')
            ->setPassword('9faa37daf7b548f141c13897585b2a77');
        ...
        <html>
          ...
          <body style="font-family: sans-serif;">
            <div style="display: block; margin: auto; max-width: 600px;" class="main">
              <h1 style="font-size: 18px; font-weight: bold; margin-top: 20px">Congrats for registering with us!</h1>
        ...
        $textBody = 'Congrats for registering with us!
Please click the following link to activate your account:
'.$verify_link;

$message = (new Swift_Message('Registration Email Confirmation'))
->setFrom(['hello@demomailtrap.co' => 'Magic Elves'])
->setTo([$to]) // just use the email directly
->setReplyTo(['hello@demomailtrap.co'])
