...
if(isset($_POST['form8'])) {
	// updating the database
	$statement = $pdo->prepare("UPDATE tbl_settings SET mod_rewrite=?,preloader_status=? WHERE id=1");
	$statement->execute(array($_POST['mod_rewrite'],$_POST['preloader_status']));
		...
		<div class="col-md-12">
				...
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs">
						...
						<li><a href="#tab_8" data-toggle="tab">PayPal Email</a></li>
						<li><a href="#tab_9" data-toggle="tab">Other</a></li>
					</ul>
